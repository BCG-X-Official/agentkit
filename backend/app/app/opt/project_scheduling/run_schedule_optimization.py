...
def load_config(current_dir: str, conversationId: str) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    try:
        config_file = (
...
def run_scheduling_opt(conversationId: str) -> Tuple[Dict[str, Any], Dict[Any, Any]]:
