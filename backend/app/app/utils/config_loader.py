...
from app.schemas.tool_schema import PromptInput, RetrievalToolConfig, SqlToolConfig, ToolConfig, ToolsLibrary
...
def get_tool_config(
    ...
    match tool_name:
        ...
        case "pdf_tool" | "code_search_tool":
            return RetrievalToolConfig(**config_values)
        case _:
