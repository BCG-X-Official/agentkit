...
class CodeSearchTool(ExtendedBaseTool):
    ...
    async def _arun(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            # Latest chat history: Get as many chat history messages, till `max_number_of_chat_history_messages`
            ...
            # logger.info(f"Code Tool retreived docs tokens length - {current_token_length}")
            #
            # # Iterate backwards through the chat history, adding messages until the token limit is reached
            # # TODO: Clean up this code and make parameters configurable
            ...
            #
            # logger.info(f"Code Tool added history messages to chat history with {current_token_length} tokens")
    ...
    def _format_source(self, doc: dict) -> str:
