...
class ProjectSchedulingRunCodeTool(ExtendedBaseTool):
    name = "run_code_tool"

    @classmethod
    def from_config(
        cls, config: ToolConfig, common_config: AgentAndToolsConfig, **kwargs
    ) -> ProjectSchedulingRunCodeTool:
    ...
    def _run(self, *args: Any, run_manager: Optional[CallbackManagerForToolRun] = None, **kwargs: Any) -> str:
        ...
        raise NotImplementedError("ProjectSchedulingRunCodeTool does not support sync")
