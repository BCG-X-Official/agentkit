...
# AgentX: rapidly build high quality Agent apps
AgentX is a LangChain-based starter kit developed by BCG X to build Agent apps. Developers can use AgentX to
...
Key advantages of the AgentX toolkit include:
