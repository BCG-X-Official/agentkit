...
const rag_examples = [
  'Get started with AgentX: "What is the quickest way to get started and run the code?"',
...
const opt_examples = [
  'Define your team: "I have 2 data scientists, 2 UX designers and 4 software engineers available"',
      ...
      <div className="group mx-auto flex w-full max-w-full flex-row items-start justify-start rounded-lg bg-base-100 p-4">
        ...
        <div className="mb-4 w-full px-4 py-3">
          <div className="text-md font-medium">
            {" "}
            I&apos;m an AgentX codebase helper. I can answer questions about the documentation, codebase, Github
            repository, and more.
          </div>
          ...
          <div className="text-md font-medium">
            {" "}
            I can also help you schedule your team&apos;s AgentX project. Define your team and project, and I will
