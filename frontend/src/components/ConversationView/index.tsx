...
const ConversationView = () => {
  ...
  const messageLimitReached = (!localStorage.getItem("openaiApiKey") && settingsStore.setting.totalMessages >= MAX_TOTAL_MESSAGES_WITHOUT_TOKEN)
  const disableMessageSend = (
