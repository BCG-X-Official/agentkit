...
import { MAX_TOTAL_MESSAGES_WITHOUT_TOKEN } from "~/utils"
...
export const SettingsModal = (props: Props) => {
  ...
  const messagedBlocked =
    settingsStore.setting.totalMessages >= MAX_TOTAL_MESSAGES_WITHOUT_TOKEN &&
  ...
  }, [settingsStore.setting.totalMessages])
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center rounded-lg bg-transparent px-cmd py-cxl dark:bg-base-100">
        {messagedBlocked && (
          <div className="flex flex-col items-center justify-center rounded-lg bg-transparent px-cmd py-cxl dark:bg-base-100">
            <h3 className="m-0 p-0 !text-fluid-cmd font-bold">Message limit reached</h3>
            <div className="daisydivider" />
            <p className="m-0 p-0 !text-fluid-cmd">
